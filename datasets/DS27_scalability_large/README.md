...
Large clean graph for the third point of the scalability curve. This scenario is part of the MASynReas benchmark catalogue and is intended to be used as a controlled, reproducible experiment.

## Scenario Profile

- Reference graph: [Base B](C:/Users/rdesb/psc/MASynReas/datasets/baseB/README.md)
- Source variant: `largeQuiescentB`
- Execution mode: `both`
- Mutation type: `scalability_large`
...
### Noise Additions
- `Two extra healthy business stacks`
...
- Scalability focus: third datapoint of the runtime curve.

## Files

- [dataset.ttl](C:/Users/rdesb/psc/MASynReas/datasets/DS27_scalability_large/dataset.ttl)
- [manifest.json](C:/Users/rdesb/psc/MASynReas/datasets/DS27_scalability_large/manifest.json)
- [expected_level1.json](C:/Users/rdesb/psc/MASynReas/datasets/DS27_scalability_large/expected_level1.json)
- [expected_level2.json](C:/Users/rdesb/psc/MASynReas/datasets/DS27_scalability_large/expected_level2.json)
